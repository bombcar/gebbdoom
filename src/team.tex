...
\footnotetext{Due to creative differences, Tom Hall left six months after completing the "Doom Bible" design doc. He went to Apogee/3D Realms to work on "Rise of the Triad" using an improved version of Wolfenstein 3D engine.}
...
\caption{Id Software office layout as can be seen in John Romero's mini-documentary "A Visit to id Software (1993)". Notice Romero's office is missing its door :) !}
\end{figure}
\par
...
\textbf{Above:} Tom Hall's "Creative Corner". \textbf{Below:} John Carmack's office next to his NeXT.\\
\\
