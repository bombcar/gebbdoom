...
\drawing{doom_map}{}
\par
To build the BSP tree, the core idea is to recursively select a line to split the map in two. Split lines become segments (\cw{SEGS}) and split sectors become sub-sectors (\cw{SSECTORS}).\\  
\par
